...
class MHDPALSTMCell(Layer):
  ...
  def __init__(self,
               ...
               implementation=1,
               **kwargs):
    super(MHDPALSTMCell, self).__init__(**kwargs)
    self.units = units
...
class MHDPALSTM(RNN):
  ...
  def call(self, inputs, mask=None, training=None, initial_state=None):
    ...
    return super(MHDPALSTM, self).call(
  ...
  def get_config(self):
    ...
    base_config = super(MHDPALSTM, self).get_config()
