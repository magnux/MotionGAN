...
for f, found_file in enumerate(tqdm(found_files)):
    ...
    # S9 and S11 will be the Validate split the rest of the subjects are the training set
    datasplit = 'Validate' if subject > 5 else 'Train'
...
print(h5file.get('Human36/Validate/'))
