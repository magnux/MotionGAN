        ...
        with K.name_scope('loss'):
            ...
            with K.name_scope('gan_loss'):
                if self.gan_type == 'wgan':
                    ...
                    # GAN-GP, https://arxiv.org/abs/1801.04406
                    Kone = K.ones((self.batch_size, 1), dtype='float32')
...
class MotionGANV87nocnn(_MotionGAN):
    # Super GAN 87
...
class MotionGANV87norelm(_MotionGAN):
    # Super GAN 87
...
class MotionGANV87nolstm(_MotionGAN):
    # Super GAN 87
